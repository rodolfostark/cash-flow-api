...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a Expenses cannot be from the future.
        /// </summary>
        public static string EXPENSES_CANNOT_FROM_THE_FUTURE {
            get {
                return ResourceManager.GetString("EXPENSES_CANNOT_FROM_THE_FUTURE", resourceCulture);
            }
        }
        ...
        /// </summary>
        public static string TITLE_REQUIRED_ERROR {
            get {
