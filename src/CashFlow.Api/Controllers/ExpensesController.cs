...
public class ExpensesController : ControllerBase
{
    ...
    public async Task<IActionResult> RegisterExpense([FromServices] IRegisterExpenseUseCase useCase, [FromBody] RequestExpenseJson request)
    {
    ...
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    [ProducesResponseType(typeof(ResponseErrorJson), StatusCodes.Status404NotFound)]
    public async Task<IActionResult> DeleteExpenseById([FromServices] IDeleteExpenseUseCase useCase, [FromRoute] long id)
    {
